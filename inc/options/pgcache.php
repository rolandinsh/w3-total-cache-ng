...
<form action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <div class="metabox-holder">
        ...
        <table class="form-table">
            ...
            <?php endif; ?>
            <?php if ($this->_config->get_string('pgcache.engine') == 'memcache'): ?>
            <tr>
                <th><label for="memcache_servers"><?php w3_e_config_label('pgcache.memcache.servers') ?></label></th>
                <td>
                    <input id="memcache_servers" type="text"
                        name="pgcache.memcache.servers"
                        <?php $this->sealing_disabled('pgcache') ?>
                        value="<?php echo esc_attr(implode(',', $this->_config->get_array('pgcache.memcache.servers'))); ?>" size="100" />
