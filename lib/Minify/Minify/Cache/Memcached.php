 ...
 * if ($memcached->connect('localhost', 11211)) {
 *     Minify::setCache(new Minify_Cache_Memcached($memcache));
 * } else {
 *     Minify::setCache();
 * }
 * </code>
...
class Minify_Cache_Memcached {
    ...
    */
     ...
     */
    public function __construct($memcached, $expire = 0, $blog_id = 0, $instance_id = 0) {
        $this->_mc = $memcached;
        $this->_exp = $expire;
