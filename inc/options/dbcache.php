...
<form action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <div class="metabox-holder">
        ...
        <table class="form-table">
            ...
            <?php endif; ?>
             <?php if ($this->_config->get_string('dbcache.engine') == 'memcache'): ?>
            <tr>
                <th><label for="memcache_servers"><?php w3_e_config_label('dbcache.memcache.servers') ?></label></th>
                <td>
                    <input id="memcache_servers" type="text"
                        name="dbcache.memcache.servers"
                        <?php $this->sealing_disabled('dbcache') ?>
                        value="<?php echo esc_attr(implode(',', $this->_config->get_array('dbcache.memcache.servers'))); ?>" size="100" />
            ...
            <tr>
                ...
                <td>
                    <input id="redis_server" type="text"
                        ...
                        <?php $this->sealing_disabled('dbcache') ?>
                        value="<?php echo esc_attr( $this->_config->get_string('dbcache.redis.server')); ?>" size="100" />
             ...
             <tr>
                <th><label for="redis_db"><?php w3_e_config_label('dbcache.redis.db') ?></label></th>
                <td>
                    <input id="redis_db" type="text"
                        name="dbcache.redis.db"
                        <?php $this->sealing_disabled('dbcache') ?>
                        value="<?php echo esc_attr($this->_config->get_integer('dbcache.redis.db')); ?>" size="100" />
