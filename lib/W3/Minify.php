        ...
        if (!isset($cache[0])) {
            switch ($this->_config->get_string('minify.engine')) {
                case "memcache":
                    ...
                    $w3_cache_memcache = new W3_Cache_Memcached(array('blog_id' => w3_get_blog_id(),
                    ...
                    $cache[0] = new Minify_Cache_Memcache($w3_cache_memcache, 0 , w3_get_blog_id(), w3_get_instance_id());
                    break;
